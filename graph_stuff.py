...
class DepthFirstSearch:
    ...
    def __init__(self, grid, start, end=None, snake_body=None):
        ...
        # Node depth.
        self.depth = np.full([self.n_rows, self.n_columns], fill_value=np.nan)
        # ID of the lowest reachable node.
        self.lowpoint = np.full([self.n_rows, self.n_columns], fill_value=np.nan)
